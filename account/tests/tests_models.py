...
class TestClient(TestWithUsersMixin, TestCase):
    ...
    def test_verbose_name(self):
        ...
        username_verbose_name = test_client1._meta.get_field('username').verbose_name
        ...
        is_active_verbose_name = test_client1._meta.get_field('is_active').verbose_name
        date_joined_verbose_name = test_client1._meta.get_field('date_joined').verbose_name
    ...
    #     test_client1 = Client.objects.get(pk=self.test_client1.pk)
    #     # TODO: White url path with name 'home'
    #     print(test_client1.get_absolute_url())
