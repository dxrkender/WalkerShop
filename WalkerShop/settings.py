"""
Django settings for WalkerShop project.
...
SECRET_KEY = 'django-insecure-9i%+w3cpny6vmldxb984(_(raqs6vi=a##3heo3)ym398pq3i^'
...
WSGI_APPLICATION = 'WalkerShop.wsgi.application'
